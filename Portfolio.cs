...
namespace Quantum
{
    ...
    {
        public static Dictionary<string, Portfolio> Portfolios = new Dictionary<string, Portfolio>();
        ...
        public Portfolio(List<string> tickers, List<double> quantities)
        {
            ...
            DataStore.ComputeOneEwmaAverageDailyReturn(PortfolioId, null);
            DataStore.ComputeOneEwmaVariance(PortfolioId, null);
