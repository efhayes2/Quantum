...
namespace Quantum
{
    ...
    {       
        internal class DrawDown
        {
            ...
            private readonly LinkedList<double> _values;
            ...
            public int TroughIndex { get; private set; }

            //peak to trough return
            public double DrawDownAmount => Peak - Trough;
            ...
            public void Add(double newValue)
            {
                ...
                if (!(newValue < Trough)) return;
                Trough = newValue;
                TroughIndex = _endIndex;
            }
            ...
            private DrawDown RecomputeDrawdownToWindowSize(bool trackingNewPeak)
            {
                ...
                if (PeakIndex < 0)
                {
                    ...
                    int iObservation = 0, iNewPeak = 0, iNewTrough = TroughIndex, iTmpNewPeak = 0, iTempTrough = 0;
                    ...
                    foreach (var pointOnDrawDown in _values)
                    {
                        ...
                        else if (iObservation == TroughIndex)
                        {
                    ...
                    PeakIndex = iNewPeak; //our drawdown now starts from here in our observation window
                    TroughIndex = iNewTrough;
        ...
        public class RunningDrawDown
        {
            ...
            /// <summary>
            /// The Dates into the Window that the Peak of the DrawDown is seen
            /// </summary>
            ...
            /// <summary>
            /// The Dates into the Window that the Trough of the DrawDown is seen
            /// </summary>
            ...
            public void Calculate(double newValue)
            {
                ...
                //if so, we can drop the old drawdowns, 
                // as for the remainer of the old drawdowns lives in our lookup window, they will be smaller than the new one
